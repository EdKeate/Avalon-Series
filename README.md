...
> 
> Attempting to use **ANY** of the components inside this repository with Future Motion™ products will result in serious injury or death. Do not attempt.
...
2. [ESP32](https://www.espressif.com/sites/default/files/documentation/esp32_datasheet_en.pdf) Power consumption (Deep-Sleep)
